        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="message_body" id="message_body" cols="80" rows="10" class="cke-editor resize_vertical">
                            ...
                            REFERENCES
                            Order number :{{ $saleorder->sale_number}}
                            Order total : {{ $saleorder->grand_total}}
                ...
                <div class="modal-footer text-right">
                    <button type="submit" class="btn btn-embossed btn-primary sendmail">{{trans('quotation.send')}}</button>
                </div>
                {!! Form::close() !!}
            </div>
        </div>
